...
fact_description(not_fever(X)):-
     nb_getval(fileOutput,Out),
     write(Out,X), write(Out,' does nothave fever'),
     write(X), write(' does nothave fever').
...
rule_description(2):-
     nb_getval(fileOutput,Out),
     write(Out,'2. If someone gets close contact with a person with Covid and he/she has not been vaccinated, and he/she does nothave symptoms, then he needs to take a pcr test.'),
     write('2. If someone gets close contact with a person with Covid and he/she has not been vaccinated, and he/she does nothave symptoms, then he needs to take a pcr test.').
...
r_description(2):-
     nb_getval(fileOutput,Out),
     write(Out,'2. If someone gets close contact with a person with Covid and he/she has been vaccinated, and he/she has not taken a pcr test, then he needs to take a pcr test.'),
     write('2. If someone gets close contact with a person with Covid and he/she has been vaccinated, and he/she has not taken a pcr test, then he needs to take a pcr test.'),nl.
