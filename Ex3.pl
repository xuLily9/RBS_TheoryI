...
initial_question(1,go_to_spain(may,sarah), "Can may and sarah go to spain together?").
...
rule_description(7):-
    write("7. If both A and B are vaccinated, and none of them have been pinged(close contact with someone who has Covid-19), and none of them have symptoms,and both of them have a test, then A and B can meet."),nl.
rule_description(8):-
    write("8. If A and B can meet and both of them have NHS Covid pass, and both of them have a negative pcr test, then A and B can go to Spain together."),nl.
