...
rule_description(2):-
    write("2. If someone gets close contact with a person with Covid and he/she hasn't been vaccinated, and he/she doesn't have symptoms, then he needs to take a pcr test."),nl.
