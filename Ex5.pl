...
r_description(1):-
     nb_getval(fileOutput,Out),
     write(Out,'1. If A has been in close contact with someone who has Covid-19, and he/she is vaccinated, and he/she has not taken a test, then he/she need to self-isolate'),
     write('1. If A has been in close contact with someone who has Covid-19, and he/she is vaccinated, and he/she has not taken a test, then he/she need to self-isolate'),nl.
r_description(2):-
     nb_getval(fileOutput,Out),
